		...
		<div class="main_prod">
			<article class="main_prod_content">
                <div class="main_prod_content_spacer">
					<header>
						<h1> Éclairs e panini</h1>
						<img src='images/panini2.jpg' height="200" width="350" alt="Éclairs e panini" title="Éclairs e panini"> 
					</header>
			...
			<article>
				<header>
					<h2 href="#" class="category"><?=$produtos[0]["title"];?><!--Panini-->
					</a></h2>
				</header>
				
                </a>
				<p><?php echo substr($produtos[0]["description"],0, 550);?>
				</br>Você vai se surpreender com essa delícia...</p>
				</br>
			</article>
