		...
		<div class="main_prod">
			<article class="main_prod_content">
                <div class="main_prod_content_spacer">
					<header>
						<h1> Copinhos de chocolate recheados</h1>
						<img src='images/copos-chocolate.png' height="200" width="350" alt="copos-chocolate" title="copos-chocolate"> 
					</header>
			...
			<article>
				<header>
					<h2 href="#prod4.php" class="category"><?=$produtos[3]["title"];?><!--copos-chocolate-->
					</a></h2>
				</header>
				
                </a>
				<p><?php echo substr($produtos[3]["description"],0, 550);?>
