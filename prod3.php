		...
		<div class="main_prod">
			<article class="main_prod_content">
                <div class="main_prod_content_spacer">
					<header>
						<h1> Camafeu</h1>
						<img src='images/camafeun.jpg' height="200" width="350" alt="Camafeu" title="Camafeu"> 
					</header>
			...
			<article>
				<header>
					<h2 href="#" class="category"><?=$produtos[2]["title"];?><!--Panini-->
					</a></h2>
				</header>
				
                </a>
				<p><?php echo substr($produtos[2]["description"],0, 550);?>
